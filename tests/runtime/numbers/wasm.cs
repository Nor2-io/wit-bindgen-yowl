...
public class NumbersImpl : NumbersWorld
{
    public static void TestImports()
    {
        ...
        Debug.Assert(Char.ConvertFromUtf32((int)TestImpl.RoundtripChar((uint)Char.ConvertToUtf32("a", 0))) == "a");
        Debug.Assert(Char.ConvertFromUtf32((int)TestImpl.RoundtripChar((uint)Char.ConvertToUtf32(" ", 0))) == " ");
        Debug.Assert(Char.ConvertFromUtf32((int)TestImpl.RoundtripChar((uint)Char.ConvertToUtf32("🚩", 0))) == "🚩");
